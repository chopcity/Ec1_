<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="_EC1.Home" %>
...
<body>
    <section>
        ...
        <div class="section1">
            <img src="Images/6cd.png" class="logo" />
        ...
        <div class="section2">
            ...
            <span class="tel-no">876-277-3551</span>


            <nav>
                <a class="menuitem" href="Home.aspx">Home</a>
                <a class="menuitem" href="Register.aspx">Register</a>
                <a class="menuitem" href="login.aspx">Login</a>
                <a class="menuitem" href="Shoppingcart.aspx">Shopping Cart</a>
                <a class="menuitem" href="Checkout.aspx">Checkout</a>
                <a class="menuitem" href="About.aspx">About</a>
            </nav>
    ...
    <div class="footer">
        ...
        <hr />
        <div class="copyright">
            <span>Powered by Scott Reid © 2019</span>
        </div>
